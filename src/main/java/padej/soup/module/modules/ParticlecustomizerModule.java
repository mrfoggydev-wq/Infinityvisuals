...
@Getter public final class ParticlecustomizerModule extends Module {
 ...
 public ParticlecustomizerModule(){super("ParticleCustomizer","Particle density control",ModuleCategory.VISUALS);}
}
