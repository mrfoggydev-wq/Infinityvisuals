...
@Getter public final class CamerasmoothingModule extends Module {
 ...
 public CamerasmoothingModule(){super("CameraSmoothing","Smooth camera transitions",ModuleCategory.PLAYER);}
}
