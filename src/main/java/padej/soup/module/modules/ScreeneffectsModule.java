...
@Getter public final class ScreeneffectsModule extends Module {
 ...
 public ScreeneffectsModule(){super("ScreenEffects","Cinematic screen effects",ModuleCategory.VISUALS);}
}
