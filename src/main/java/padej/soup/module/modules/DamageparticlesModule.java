...
@Getter public final class DamageparticlesModule extends Module {
 ...
 public DamageparticlesModule(){super("DamageParticles","Combat particle style",ModuleCategory.VISUALS);}
}
