...
@Getter public final class InventorymoveModule extends Module {
 ...
 public InventorymoveModule(){super("InventoryMove","Movement in inventory",ModuleCategory.PLAYER);}
}
